...
function seoMadeEasy_str2url($str)
{
  $str = $safe = seoMadeEasy_transliterate($str);
 ...
 function seoMadeEasy_transliterate($term)
    {
      return seoMadeEasy_remove_accents( mb_strtolower($term, PWG_CHARSET) );
    }
function seoMadeEasy_qualify_utf8($Str)
{
  $ret = 0;
...
function seoMadeEasy_remove_accents($string)
{
  $utf = seoMadeEasy_qualify_utf8($string);
  if ( $utf == 0 )
  {
    return $string; // ascii
  }
